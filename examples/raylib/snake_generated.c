...
void Vector_rlVector2_call_destructor_for_element(struct Vector_rlVector2 *this,
                                                  int index);
void Vector_rlVector2_call_destructor_for_all_elements(
    struct Vector_rlVector2 *this);
void Vector_rlVector2_reset(struct Vector_rlVector2 *this);
...
struct rlVector2 Vector_rlVector2__getitem__(struct Vector_rlVector2 *this,
                                             int index);
void Vector_rlVector2_set_ith_item(struct Vector_rlVector2 *this, int index,
                                   struct rlVector2 value);
void Vector_rlVector2push_unchecked(struct Vector_rlVector2 *this,
                                    struct rlVector2 value);
void Vector_rlVector2validate_index(struct Vector_rlVector2 *this, int index);
void Vector_rlVector2_set(struct Vector_rlVector2 *this, int index,
                          struct rlVector2 value);
...
void Vector_rlVector2_grow_if_required(struct Vector_rlVector2 *this);
void Vector_rlVector2_push(struct Vector_rlVector2 *this,
                           struct rlVector2 value);
...
void Vector_rlVector2_call_destructor_for_all_elements(
    struct Vector_rlVector2 *this) {
  for (size_t i = 0; i < Vector_rlVector2len(this); i++) {
    Vector_rlVector2_call_destructor_for_element(this, i);
  }
}
...
void Vector_rlVector2__del__(struct Vector_rlVector2 *this) {
  Vector_rlVector2_call_destructor_for_all_elements(this);
  Vector_rlVector2_reset(this);
}
...
void Vector_rlVector2_set(struct Vector_rlVector2 *this, int index,
  ...
  Vector_rlVector2_set_ith_item(this, index, value);
}

void Vector_rlVector2__setitem__(struct Vector_rlVector2 *this, int index,
                                 struct rlVector2 value) {
  Vector_rlVector2_set(this, index, value);
}
...
void Vector_rlVector2allocate_more(struct Vector_rlVector2 *this, int n) {
  ...
  size_t new_capacity = this->capacity + n;
  struct rlVector2 *new_arr = (struct rlVector2 *)realloc(
      this->arr, new_capacity * sizeof(struct rlVector2));
...
void Vector_rlVector2_grow_if_required(struct Vector_rlVector2 *this) {
  ...
  if (this->size >= this->capacity) {
    ...
    if (this->capacity > 0) {
      Vector_rlVector2allocate_more(this, this->capacity);
    } else {
      // Avoid 0 capacity.
      Vector_rlVector2allocate_more(this, 1);
    }
  }
}
...
void Vector_rlVector2_push(struct Vector_rlVector2 *this,
                           struct rlVector2 value) {
  Vector_rlVector2_grow_if_required(this);
  Vector_rlVector2push_unchecked(this, value);
}

void Vector_rlVector2push(struct Vector_rlVector2 *this,
                          struct rlVector2 value) {
  Vector_rlVector2_push(this, value);
}
...
void Vector_rlVector2_shift_left_from(struct Vector_rlVector2 *this,
                                      int index) {
  // NOTE: The index is assumed to be valid(i.e not negative and within bounds).
  for (int i = index; i < this->size - 1; i++) {
    this->arr[i] = this->arr[i + 1];
